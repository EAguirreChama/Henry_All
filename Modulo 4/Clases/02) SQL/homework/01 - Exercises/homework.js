...
const ejercicio06 = 'SELECT title, AVG(rating) FROM movies, unnest(ratings) raiting GROUP BY title;';

const ejercicio07 = 'SELECT actors FROM movies WHERE (title LIKE '%Fast %' AND year = 2016);';
